% Added the return model over fooof_group code
...
%
%Version 2 created on 14-3-22 by Srishty
% Contains fooofed spectrum to achieve fooof plot for fooof_group
% 
% Notes
...
function fooof_results = fooof_group_new(freqs, psds, f_range, settings,return_model)
    ...
    for psd = psds %for loop takes column one by one
